      ...
      <section className="mx-auto max-w-2xl px-6 py-20 lg:px-10">
        ...
        <Reveal delay={0.08}>
          {sent ? (
            ...
            >
              <div>
                <label className="text-[11px] uppercase tracking-widest2 text-stone">Name</label>
                <input
                  required
                  type="text"
              ...
              <div>
                <label className="text-[11px] uppercase tracking-widest2 text-stone">Email</label>
                <input
                  required
                  type="email"
                  className="mt-2 w-full border-b border-black/15 bg-transparent py-2 text-sm focus:border-ink focus:outline-none"
              ...
              <div>
                <label className="text-[11px] uppercase tracking-widest2 text-stone">Message</label>
                <textarea
                  required
                  rows={5}
                  className="mt-2 w-full border-b border-black/15 bg-transparent py-2 text-sm focus:border-ink focus:outline-none"
